...
#define TMU_TEMP_PATH1 "sys/devices/platform/nxp-tmu.0/temp_label"
#define TMU_TEMP_PATH2 "sys/devices/platform/nxp-tmu.1/temp_label"

#define TMU_LOW_RANGE 30
#define TMU_HIGH_RANGE 60


#define SUPPORT_CH1 0
...
int main(int argc, char **argv)
{
	...
	fd = open(TMU_TEMP_PATH1,O_RDONLY);
	if(fd < 0)
	{
	...
	fd1 = open(TMU_TEMP_PATH2,O_RDONLY);
	if(fd1 < 0)
	{
		printf("open test_fail TMU ch 0\n");
		goto test_fail;
