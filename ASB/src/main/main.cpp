...
enum {
	...
	BIN_VIP_0        =  70,	//	MIPI_DSI loopback
...
static TEST_ITEM_INFO gTestItems[] =
{
	...
	{ BIN_ADC        , "/root/adc_test",         "ADC Test        ", "-m ASB -n 1",                     1, 0, 0 },
	...
	{ BIN_VIP_1      , "/root/sfr_test",         "VIP 1 Test      ", "-a c0063010 -w ffff -m ffff -t",	1, 0, 0 },
	{ BIN_VIP_2      , "/root/sfr_test",         "VIP 2 Test      ", "-a c0099010 -w ffff -m ffff -t",	1, 0, 0 },
	//{ BIN_VIP_2      , "/root/asb_loopback",     "VIP 2 Test      ", "",	                            1, 0, 0 },
...
#if 0
	if(0 > NX_AppIsRunning( "memtester" ))
	{
		printf("\033[43m");
		printf(" Memory faild \n");
		printf("\033[0m\r\n");
